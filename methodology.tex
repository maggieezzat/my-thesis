...
\includefig{0.8}{articles_per_class}{10KGNAD: Articles per Class}{Fig:28}
...
\includefig{0.8}{bert_classifier}{The task specific models are formed by building an output layer on top of BERT, so that small number of parameters need to be learned from scratch}{Fig:28}
